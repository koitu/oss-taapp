...
class MessageDetail:
    ...
    Attributes:
        ...
        edited_timestamp (Union[None, Unset, str]): Edit timestamp if edited
    """
    ...
    content: str
    timestamp: str
    edited_timestamp: None | Unset | str = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        edited_timestamp: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_edited_timestamp(data: object) -> None | Unset | str:
            if data is None:
                return data
